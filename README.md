...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/scapy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7058&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/scapy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `scapy` can be installed with:

```
conda install scapy
```

It is possible to list all of the versions of `scapy` available on your platform with:
